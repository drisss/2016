...
def print_tweets_annotation(match_dirpath):
        ...
        for fname in fname_lst :
            ...
            only_team_events = [x  for x in events if (x.getNbPlayers() == '0' and x.getNbTeams() == '1')]
            ...
            tweets_with_no_player = read_tsv_tweet_file(os.path.join(match_dirpath,"tweets_with_no_player.tsv"),players)
            tweets_with_a_team_no_player = read_tsv_tweet_file(os.path.join(match_dirpath,"tweets_with_a_team_no_player.tsv"),players)
            tweets_with_single_players = read_tsv_tweet_file(os.path.join(match_dirpath,"tweets_with_single_players.tsv"),players)
            tweets_with_two_players = read_tsv_tweet_file(os.path.join(match_dirpath,"tweets_with_two_players.tsv"),players)
